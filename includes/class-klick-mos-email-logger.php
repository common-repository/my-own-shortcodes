...
if (class_exists('Klick_Mos_EMAIL_Logger')) return;

/**
 * Class Klick_Mos_EMAIL_Logger
 */
class Klick_Mos_EMAIL_Logger extends Klick_Mos_Abstract_Logger {
	...
	/**
	 * Klick_Mos_EMAIL_Logger constructor
	 */
	...
	public function get_description() {
		return __('Log events into Url address', 'klick-mos');
	}
