...
if (class_exists('Klick_Mos_Notifier')) return;

/**
 * Class Klick_Mos_Notifier
 */
class Klick_Mos_Notifier {
	...
	/**
	 * Klick_Mos_PHP_Notifier constructor
	...
	public function __construct() {
		...
		$folder = opendir(KLICK_MOS_PLUGIN_MAIN_PATH . 'notices');
	...
	public function add_noitice($notice_file) {
		...
		$notice_file = KLICK_MOS_PLUGIN_MAIN_PATH . 'notices' . '/' . $notice_file;
